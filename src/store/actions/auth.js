...
export const auth = (email, password, isSignup) => {
  return dispatch => {
    ...
    let url =
      "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDr2ERkm1u89kyL0fOhMpVQW03gvN39cYY";
    if (!isSignup) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDr2ERkm1u89kyL0fOhMpVQW03gvN39cYY";
    }
